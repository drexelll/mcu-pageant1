        ...
        <div class="filter-group">
            ...
            <div class="filter-pills" id="roleFilters">
                @foreach (['sas', 'admin', 'tabulator', 'guest', 'judge'] as $r)
                    <button class="filter-pill" data-filter="role" data-value="{{ $r }}"
                        onclick="toggleFilterPill(this)">
                        {{ ucfirst($r) }}
                    </button>
                @endforeach
            </div>
        ...
        <div class="filter-group">
            ...
            <div class="filter-pills" id="statusFilters">
                @foreach (['active', 'inactive', 'pending'] as $s)
                    <button class="filter-pill" data-filter="status" data-value="{{ $s }}"
                        onclick="toggleFilterPill(this)">
                        {{ ucfirst($s) }}
                    </button>
                @endforeach
    ...
    <div class="table-bottom-bar">
        ...
        <div class="pagination-wrap">
            ...
            @php
                ...
                $range = collect(range(1, $lastPage))->filter(
